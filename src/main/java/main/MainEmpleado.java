...
public class MainEmpleado {
	...
	public static void main(String[] args) {
		...
		System.out.println("Trabajadores filtrados por JOB:");
		emps=empleadoServicio.findByJob("Contable");
		for (Empleado empleado : emps) {
			System.out.println("El empleado recuperado es: " + empleado);
		}
		int numEmpExiste=2;
		boolean existeEmpleado=empleadoServicio.exists(numEmpExiste);
		if(existeEmpleado){
			System.out.println("El empleado "+numEmpExiste+" existe");
		}else{
			System.out.println("El empleado "+numEmpExiste+" NO existe");
		}
